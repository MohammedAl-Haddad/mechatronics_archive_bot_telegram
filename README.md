...
- أوامر `/start`, `/approvals`, `/admins` تُنفَّذ في المحادثة الخاصة مع البوت فقط.
- أوامر `/insert_group`, `/insert_sub` يجب أن تُرسَل داخل المجموعات/المواضيع.
- أي نص عام داخل المجموعات يتم تجاهله ولا يردّ عليه البوت.
